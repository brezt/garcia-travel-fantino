    ...
    <section className="py-20 px-6 bg-white" id="paquetes">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-brand-navy/60 text-sm">Disenados para transformar tu proxima aventura por el mundo.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <motion.div initial={false} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-white rounded-[2rem] border border-brand-slate overflow-hidden flex flex-col sm:flex-row shadow-sm hover:shadow-xl transition-all h-[350px]">
            <div className="w-full sm:w-[45%] relative h-48 sm:h-full">
              ...
              <Image src="https://images.unsplash.com/photo-1543731068-7e0f5beff43a?q=80&w=1974&auto=format&fit=crop" alt="Escapada Romantica" fill sizes="(min-width: 768px) 23vw, 100vw" className="object-cover" />
            </div>
            <div className="p-8 flex flex-col justify-center flex-1">
              <h3 className="text-2xl font-black text-brand-navy font-montserrat uppercase leading-tight mb-1">Escapada</h3>
              <h3 className="text-2xl font-black text-brand-teal font-montserrat uppercase leading-tight mb-4">Romantica</h3>
              ...
              <button onClick={() => openWhatsApp("Hola, me interesa el paquete de Escapada Romantica. Podrian enviarme mas detalles?")} className="bg-brand-teal text-white text-xs font-bold px-6 py-3 rounded-full uppercase tracking-wider hover:bg-brand-teal/90 transition-colors w-max">Descubrir</button>
            </div>
          </motion.div>
          ...
          <motion.div initial={false} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="bg-white rounded-[2rem] border border-brand-slate overflow-hidden flex flex-col shadow-sm hover:shadow-xl transition-all h-[350px]">
            <div className="p-8 pb-4">
              ...
              <p className="text-xs text-brand-navy/60 mb-4 max-w-sm">Explora, surfea y siente la adrenalina en las montanas.</p>
            </div>
          ...
          <motion.div initial={false} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="bg-brand-slate/50 rounded-[2rem] overflow-hidden flex flex-col shadow-sm hover:shadow-xl transition-all h-[350px]">
            <div className="p-8 pb-4">
              ...
              <p className="text-xs text-brand-navy/60 mb-4 max-w-sm">Diversion para ninos y descanso total para los padres.</p>
            </div>
            <div className="relative flex-1 m-4 mt-0 rounded-2xl overflow-hidden">
              ...
              <button onClick={() => openWhatsApp("Hola, quisiera informacion sobre paquetes de viaje familiares en resorts.")} className="absolute bottom-4 right-4 bg-white text-brand-navy text-[10px] font-bold px-4 py-2 rounded-full shadow-lg hover:bg-brand-slate transition-colors flex items-center gap-2"><Sun size={12} className="text-brand-gold" />Resorts</button>
            </div>
          </motion.div>
          ...
          <motion.div initial={false} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="bg-[#1A1A1A] rounded-[2rem] overflow-hidden flex flex-col sm:flex-row shadow-sm hover:shadow-xl transition-all h-[350px]">
            <div className="p-8 flex flex-col justify-center flex-1 order-2 sm:order-1">
              ...
              <p className="text-xs text-white/60 mb-6 max-w-[180px]">Cruceros, Europa, Asia y America Latina. Asesoria de visado y seguro de viaje.</p>
              <button onClick={() => openWhatsApp("Hola, estoy interesado/a en un viaje internacional Mundo Global. Podrian asesorarme?")} className="bg-brand-cyan text-brand-navy text-[10px] font-black px-6 py-3 rounded-full uppercase tracking-wider hover:bg-white transition-colors w-max">Consultar</button>
            </div>
